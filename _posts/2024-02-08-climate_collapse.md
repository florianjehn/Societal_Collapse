...
(4) This is in line with [other papers we discussed](https://existentialcrunch.substack.com/p/famines-role-in-societal-collapse?open=false#%C2%A7famines-have-many-triggers) that highlight that the biggest crop production shocks are caused by droughts. 

(5) As a reminder what critical slowing down means, here’s the explanation from my tipping points post: *“The main way to detect tipping points are so-called Early-Warning Signals. They work by identifying changes in a system’s behavior as it approaches a tipping point. This change is often marked by a phenomenon known as critical slowing down, where the system becomes less resilient to disturbances. This means once a disturbance happens it takes longer and longer to get back to its original state the closer it is to the tipping point.“*

(6) The first major paper they produced from this crisis dataset is discussed [here](https://florianjehn.github.io/Societal_Collapse/2024-04-09-big_data_history/).
