---
layout: post
title: How much do we actually know about AMOC collapse?
subtitle: Exploring uncertain timelines and consequences
...
Every time you have a big change in climate, a large impact on agriculture follows. Strangely, there aren’t many good crop modeling studies around AMOC. A good one currently is arguably Ritchie et al. (2020). They modelled the impact of AMOC collapse for agriculture in Great Britain. The results are pretty stark. Due to changes in temperature, and especially precipitation most of the current farmland in Great Britain would revert to grasslands. This could be counteracted by widespread irrigation, but this would likely be prohibitively expensive in many places. They estimate that the damages to agriculture would be a magnitude larger than the ones by climate change alone. 

There is also an assessment by the OECD (2021). Their report is generally concerned with all kinds of climate tail risks and also has a chapter on AOMC collapse. They did not run their own models, but re-analyzed the work done by others (e.g. the Jackson et al. paper mentioned above). This allowed them to also explore the changes in suitability for crops (Figure 5), following a combination of AMOC collapse and 2.5°C warming. They did not run a crop model, they just checked which cells would generally be in a climate range suitable for different kinds of crops and compared the results for the control run with the scenario of 2.5°C warming + AMOC collapse. They find in such a scenario that around 50 % of the land suitable for wheat and maize is lost, while rice experiences a slight increase in suitable area. These results sound extreme, but keep in mind that they did this analysis for the global land surface, not only the area where these crops are actually grown. The majority of places becoming unsuitable for wheat and maize did not grow these crops in the first place. Still, this analysis gives a good sense of the importance of AMOC for global climate and food systems.

![AMOC Crop Impacts](https://raw.githubusercontent.com/florianjehn/Societal_Collapse/main/assets/img/AMOC_crops.png)

Figure 5: Changes in suitability for crop growth following 2.5°C of warming and AMOC collapse. 

Besides these assessments, there is not much research to go on, but based on the changed patterns of precipitation and temperature, one could expect that agriculture in Europe more generally would be affected, as would those regions that have high changes in precipitation like India, Central America or parts of South-East Asia. These are all areas where a lot of food is grown. Though it is difficult to estimate those changes.
...
# How to cite
Jehn, F. U. (2026, July 1). How much do we actually know about AMOC collapse?. Existential Crunch. https://doi.org/10.59350/sse7m-1nn58

#  Endnotes
(1) See [Ben-Yami et al. (2024)](https://www.science.org/doi/epdf/10.1126/sciadv.adl4841) for a detailed critique of Ditlevsen and Ditlevsen (2023).

(2) Tipping points are described in more detail in [this post](https://existentialcrunch.substack.com/p/the-trouble-with-tipping-points). 

(3) See the more recent van [Westen & Baatsen (2025)](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2025GL114611) for a confirmation of the results from Jackson et al. (2015). 
...
* OECD. (2021). Managing Climate Risks, Facing up to Losses and Damages: Understanding, Reducing and Managing Risks. OECD Publishing. https://doi.org/10.1787/55ea1cc9-en 
