...
readtime: true
---
*This post was originally an invited contribution to the [United Nations Independent Scientific Panel on the Effects of Nuclear War](https://www.unoda.org/en/panel-effects-nuclear-war/home). I'm also sharing it here as an overview of the current state of nuclear winter research (+ related topics) and the open questions the field is grappling with. It was written by me with extensive input from the team at the [Alliance to Feed the Earth in Disasters (ALLFED)](https://allfed.info/), whose comments and suggestions greatly improved it.*
